...
Shader "CatShader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float temp_output_30_0 = ( 1.0 - tex2DNode2.r );
			...
			float4 temp_output_23_0 = ( _BaseColor + ( ( _BaseColor * _HightligtMul ) * saturate( floor( ( ( 1.0 - fresnelNode12 ) + _ShadowSize ) ) ) ) );
			float4 temp_cast_0 = (tex2DNode2.a).xxxx;
			float layeredBlendVar87 = tex2DNode2.a;
			float4 layeredBlend87 = ( lerp( temp_output_23_0,temp_cast_0 , layeredBlendVar87 ) );
			float4 temp_output_24_0 = ( temp_output_30_0 * _TexColor );
			float layeredBlendVar88 = temp_output_30_0;
			float4 layeredBlend88 = ( lerp( layeredBlend87,temp_output_24_0 , layeredBlendVar88 ) );
			o.Emission = layeredBlend88.rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=17500
627;75;1469;981;473.0795;1120.571;1.077709;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;80;-198.2671,-117.7357;Inherit;False;Property;_HightligtMul;HightligtMul;12;0;Create;True;0;0;False;0;0;0.25;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;15;-197.1543,-333.2077;Inherit;False;Property;_BaseColor;BaseColor;4;0;Create;True;0;0;False;0;1,1,1,0;0.745283,0.471655,0.2144446,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;81;2410.03,1048.353;Inherit;False;Property;_OutlineMul;OutlineMul;13;0;Create;True;0;0;False;0;0;0.45;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;2;-286.7664,-641.4193;Inherit;True;Property;_MainTex;MainTex;1;0;Create;True;0;0;False;0;-1;e95be7a497c214285b0f7ff7de1ba3a6;5ff0be1138ce345f38e8ec78fda94c8b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;30;107.8164,-920.5964;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;23;593.2114,-250.6942;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LayeredBlendNode;87;551.894,-1052.855;Inherit;True;6;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;364.7274,-477.2567;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LayeredBlendNode;88;972.7805,-927.0547;Inherit;True;6;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LayeredBlendNode;36;964.7743,-448.5419;Inherit;True;6;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;87;0;2;4
WireConnection;87;1;23;0
WireConnection;87;2;2;4
...
ASEEND*/
//CHKSM=68832C0E6A826EF13243EEA72725757D146AFB82